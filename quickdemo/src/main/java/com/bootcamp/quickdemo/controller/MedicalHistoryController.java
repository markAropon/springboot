...
public class MedicalHistoryController {
    ...
    public ApiResponse<MedicalHistoryDTO> getById(
        @Parameter(description = "ID of the medical history record to retrieve", required = true, example = "1")
    ...
    public ApiResponse<List<MedicalHistoryDTO>> getByPatient(
        @Parameter(description = "ID of the patient to retrieve medical history for", required = true, example = "1")
    ...
    public ApiResponse<MedicalHistoryDTO> create(
        @Parameter(description = "Medical history details", required = true)
        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Medical history record that needs to be added",
            content = @Content(schema = @Schema(implementation = MedicalHistoryDTO.class)))
    ...
    public ApiResponse<MedicalHistoryDTO> update(
        @Parameter(description = "ID of the medical history record to update", required = true, example = "1")
        @PathVariable Long id, 
        @Parameter(description = "Updated medical history details", required = true)
        @RequestBody MedicalHistoryDTO dto) {
    ...
    public ApiResponse<Void> delete(
        @Parameter(description = "ID of the medical history record to delete", required = true, example = "1")
        @PathVariable Long id) {
        service.delete(id);

...
public class DefaultResponse {
     ...
     *
     * @param object the authenticated object (e.g., AuthResponseDto) to include in
     *               the response body.
     * @param <T>    the type of the object.
     * @return an {@link ApiResponse} with HTTP status 200 (OK) and the object.
     */
    ...
    /**
     * Returns a response indicating an internal server error (500) with an error
     * object.
     */
    ...
    public static <T> ApiResponse<T> displayOkObject(T dataObject) {
        return createResponse(HttpStatus.OK, true, "User logged out successfully", dataObject, 200);
    }
